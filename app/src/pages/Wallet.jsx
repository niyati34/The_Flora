        ...
        <div className="col-md-4 mb-4">
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body text-center">
              ...
              <h2 className="display-4 text-success mb-3">
              ...
              <div className="mb-3">
                ...
                <div className="progress mb-2" style={{ height: "8px" }}>
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        (budgetStatus.daily.spent / budgetStatus.daily.limit) *
                          100,
                        100
                      )}%`,
                      backgroundColor:
                ...
                <small>
                  {formatCurrency(budgetStatus.daily.spent)} /{" "}
                  {formatCurrency(budgetStatus.daily.limit)}
                </small>
              </div>
              <div className="mb-3">
                ...
                <div className="progress mb-2" style={{ height: "8px" }}>
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        (budgetStatus.weekly.spent /
                          budgetStatus.weekly.limit) *
                          100,
                        100
                      )}%`,
                      backgroundColor:
                        budgetStatus.weekly.spent > budgetStatus.weekly.limit
                          ? "#dc3545"
                          : "#28a745",
                    }}
                  ></div>
                ...
                <small>
                  {formatCurrency(budgetStatus.weekly.spent)} /{" "}
                  {formatCurrency(budgetStatus.weekly.limit)}
                </small>
              </div>
              <button
              ...
              <div className="row text-center">
                <div className="col-6">
                  ...
                  <p className="h5 text-success">
                    {formatCurrency(analytics.totalEarned)}
                  </p>
                </div>
                <div className="col-6">
